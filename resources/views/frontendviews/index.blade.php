            ...
            <div class="home__slider-sec-wrap">
                ...
                <div class="home__slider-items-wrapper">
                    <div class="home__slider-item-outer">
                        <img src="{{asset('/frontendassets/assets/images/slider.jpg')}}" alt="image" class="home__slider-item-image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="banner-item-outer">
                        <img src="{{asset('/frontendassets/assets/images/banner.jpeg')}}" alt="banner image" />
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="banner-item-outer">
    ...
    <section class="product-section">
        <div class="container">
            <div class="section-title-outer">
                ...
                <a href="/product_type" class="product-view-all-btn">
                    View All
                </a>
            </div>
            <div class="product-items-wrapper">
                <div class="product__item-outer">
                    <div class="product__item-image-outer">
                        <a href="/product_details" class="product__item-image-inner">
                            <img src="{{asset('/frontendassets/assets/images/product.png')}}" alt="Product Image" />
                        </a>
                        <div class="product__item-add-cart-btn-outer">
                            <a href="/product_details" class="product__item-add-cart-btn-inner">
                                Add to Cart
                            </a>
                        </div>
        ...
        <div class="container">
            ...
            <div class="product-items-wrapper">
                <div class="product__item-outer">
                    <div class="product__item-image-outer">
                        <a href="/product_details" class="product__item-image-inner">
                            <img src="{{asset('/frontendassets/assets/images/product1.jpg')}}" alt="Product Image" />
                        </a>
                        <div class="product__item-add-cart-btn-outer">
                            <a href="/product_details" class="product__item-add-cart-btn-inner">
                                Add to Cart
